    ...
    data: [
      {
        ...
        hours: 8,
        billable: true,
        cost: 480, // 8 hours * 60/hour
        note: 'Wireframe design work',
      },
      {
        projectId: project1.id,
        taskId: task1.id,
        userId: developer.id,
        workDate: new Date('2025-01-11'),
        hours: 6,
        billable: true,
        cost: 360,
        note: 'Continued wireframe work',
      },
      {
        projectId: project1.id,
        taskId: task2.id,
      ...
      },
      {
        ...
        billable: true,
        cost: 240,
        note: 'Homepage responsive design',
      },
    ],
  })
