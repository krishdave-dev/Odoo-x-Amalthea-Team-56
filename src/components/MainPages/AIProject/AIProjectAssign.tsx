    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      <div className="mb-8">
        ...
        <p className="mt-2 text-[#4A7FA7]">
          Describe your project and we’ll generate a draft plan with suggested
          task assignments. (UI only for now)
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Provide a short description so AI can plan tasks and assignments.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Example: Redesign marketing site with a modern UI, build product
                pages and a blog, integrate CMS, and set up analytics.
              </p>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Draft tasks and assignments (placeholder)
            </CardDescription>
          </CardHeader>
          <CardContent>
            {!generated ? (
              <div className="text-muted-foreground text-sm">
                Fill in the brief and click &quot;Generate Plan&quot; to preview
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {suggestedTasks.map((t, idx) => (
                    <div
                      key={idx}
                      className={cn("rounded-lg border p-3", "bg-white/50")}
                    >
                      ...
                      <div className="mt-1 text-sm text-muted-foreground">
                        Role: <span className="text-foreground">{t.role}</span>{" "}
                        • Assignee:{" "}
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <Wand2 className="h-5 w-5 text-primary" /> Creating project with
              AI
            </DialogTitle>
            <DialogDescription>
              Hang tight while we analyze your brief, plan milestones, assign
              teammates, and generate tasks.
            </DialogDescription>
          </DialogHeader>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      active ? "bg-primary/10 border-primary/30" : "bg-white/40"
                    )}
                  >
                    <Icon
                      className={cn(
