...
export default function SignupPage() {
  ...
  // Fetch invitation details if token provided (inline to satisfy deps)
  useEffect(() => {
      ...
      <div className="w-full md:w-1/2 lg:w-2/5 flex items-center justify-center px-6 py-12">
        <Card className="w-full max-w-md shadow-xl border-0 bg-white">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-left text-[#0A1931]">
              {invitation ? 'Complete Your Registration' : 'Create an account'}
            </CardTitle>
            <CardDescription className="text-[#4A7FA7] text-left">
              {invitation 
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {invitation && (
                <div className="bg-[#E8F2FA] border border-[#B3CFE5] text-[#1A3D63] px-4 py-3 rounded-md text-sm">
              ...
              <div className="space-y-2">
                <Label htmlFor="name" className="text-[#0A1931]">Full Name</Label>
                <Input
                  id="name"
                  type="text"
              ...
              {!invitation && (
                <div className="space-y-2">
                  <Label htmlFor="role" className="text-[#0A1931]">Role</Label>
                  <Select
                    value={role}
                    onValueChange={(value) => {
                      setRole(value)
              ...
              {!invitation && (
                <>
                  ...
                  <div className="flex items-center space-x-2 p-4 bg-[#F6FAFD] rounded-lg border border-[#B3CFE5]">
                    <input
                      type="checkbox"
                      id="createNewOrg"
                      ...
                      className="h-4 w-4 text-[#1A3D63] focus:ring-[#1A3D63] border-[#B3CFE5] rounded"
                    />
                    <div className="flex-1">
                      <Label htmlFor="createNewOrg" className="font-medium cursor-pointer flex items-center gap-2 text-[#0A1931]">
                        <Building2 className="h-4 w-4" />
                        Create a new organization
                      </Label>
                      <p className="text-xs text-[#4A7FA7] mt-0.5">
                        {role === 'admin' 
                  ...
                  {createNewOrg ? (
                    <div className="space-y-2">
                      <Label htmlFor="organizationName" className="text-[#0A1931]">Organization Name</Label>
                      <Input
                        id="organizationName"
                        type="text"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="organization" className="text-[#0A1931]">Organization</Label>
                      <Select
              ...
              <div className="text-center text-sm text-[#0A1931]">
                ...
                <Link href="/login" className="text-[#4A7FA7] hover:text-[#1A3D63] font-medium">
                  Sign in
                </Link>
              </div>
            </form>
